defprotocol PersistentTree.Day10.Tree do
  def add(tree, val)
  def preorder(tree)
  def postorder(tree)
  def in_order(tree)
...
defmodule PersistentTree.Day10.Leaf,
          do: defstruct []

defmodule PersistentTree.Day10.Node,
          do: defstruct [:item, :left, :right]

defimpl PersistentTree.Day10.Tree, for: PersistentTree.Day10.Leaf do
  alias PersistentTree.Day10.Node
...
defimpl PersistentTree.Day10.Tree, for: PersistentTree.Day10.Node do
  alias PersistentTree.Day10.{Node, Leaf, Tree}
...
defmodule PersistentTree.Day10 do
  alias PersistentTree.Day10.{Leaf, Tree}
