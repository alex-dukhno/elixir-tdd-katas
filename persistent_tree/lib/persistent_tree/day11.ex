defprotocol PersistentTree.Day11.Tree do
  def add(tree, val)
  def preorder(tree)
  def postorder(tree)
  def in_order(tree)
...
defmodule PersistentTree.Day11.Leaf, do: defstruct []
defmodule PersistentTree.Day11.Node, do: defstruct [:item, :left, :right]

defimpl PersistentTree.Day11.Tree, for: PersistentTree.Day11.Leaf do
  alias PersistentTree.Day11.Node
...
defimpl PersistentTree.Day11.Tree, for: PersistentTree.Day11.Node do
  alias PersistentTree.Day11.{Leaf, Node, Tree}
...
defmodule PersistentTree.Day11 do
  alias PersistentTree.Day11.{Leaf, Tree}
