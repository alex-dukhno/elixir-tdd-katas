defprotocol PersistentTree.Day13.Tree do
  def add(tree, val)
  def preorder(tree)
  def postorder(tree)
  def in_order(tree)
...
defmodule PersistentTree.Day13.Leaf, do: defstruct []
defmodule PersistentTree.Day13.Node, do: defstruct [:item, :left, :right]

defimpl PersistentTree.Day13.Tree, for: PersistentTree.Day13.Leaf do

  alias PersistentTree.Day13.{Leaf, Node}

  def add(empty = %Leaf{}, val),
...
defimpl PersistentTree.Day13.Tree, for: PersistentTree.Day13.Node do

  alias PersistentTree.Day13.{Leaf, Node, Tree}
...
defmodule PersistentTree.Day13 do
  alias PersistentTree.Day13.{Leaf, Tree}
