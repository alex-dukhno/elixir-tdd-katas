defprotocol PersistentTree.Day12.Tree do
  def add(tree, val)
  def preorder(tree)
  def postorder(tree)
  def in_order(tree)
...
defimpl PersistentTree.Day12.Tree, for: PersistentTree.Day12.Leaf do
  alias PersistentTree.Day12.{Leaf, Node}
...
defimpl PersistentTree.Day12.Tree, for: PersistentTree.Day12.Node do
  alias PersistentTree.Day12.{Leaf, Node, Tree}
...
defmodule PersistentTree.Day12 do
  alias PersistentTree.Day12.{Leaf, Tree}
