defmodule BowlingGame.Day11Test do
  use ExUnit.Case, async: true

  alias BowlingGame.Day11, as: BowlingGame
  ...
  test "all ones", %{game: game},
       do: assert game
                  |> roll_many(20, 1)
                  |> BowlingGame.score() == 20

  test "one spare", %{game: game},
       do: assert game
                  |> roll_spare()
                  |> BowlingGame.roll(3)
                  |> roll_many(17, 0)
