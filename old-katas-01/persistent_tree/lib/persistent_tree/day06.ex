defprotocol PersistentTree.Day06.Tree do
  def add(tree, val)
  def preorder(tree)
  def postorder(tree)
  def in_order(tree)
...
defmodule PersistentTree.Day06.Leaf, do: defstruct []
defmodule PersistentTree.Day06.Node, do: defstruct [:item, :left, :right]

defimpl PersistentTree.Day06.Tree, for: PersistentTree.Day06.Leaf do
  alias PersistentTree.Day06.Leaf
  alias PersistentTree.Day06.Node

  def add(empty = %Leaf{}, val), do: %Node{item: val, left: empty, right: empty}
  def preorder(_empty), do: []
  def postorder(_empty), do: []
  def in_order(_empty), do: []
end

defimpl PersistentTree.Day06.Tree, for: PersistentTree.Day06.Node do
  alias PersistentTree.Day06.Leaf
  alias PersistentTree.Day06.Node
  alias PersistentTree.Day06.Tree
...
defmodule PersistentTree.Day06 do
  alias PersistentTree.Day06.Leaf
  alias PersistentTree.Day06.Tree
  ...
  def add(tree, val),
      do: tree
          |> PersistentTree.Day06.Tree.add(val)
