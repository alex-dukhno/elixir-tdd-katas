defmodule PersistentTree.Day07.Leaf, do: defstruct []
defmodule PersistentTree.Day07.Node, do: defstruct [:item, :left, :right]

defprotocol PersistentTree.Day07.Tree do
  def add(tree, val)
...
defimpl PersistentTree.Day07.Tree, for: PersistentTree.Day07.Leaf do
...
defimpl PersistentTree.Day07.Tree, for: PersistentTree.Day07.Node do
  alias PersistentTree.Day07.Leaf
  alias PersistentTree.Day07.Node
  alias PersistentTree.Day07.Tree
...
defmodule PersistentTree.Day07 do
  alias PersistentTree.Day07.Leaf
  alias PersistentTree.Day07.Tree
